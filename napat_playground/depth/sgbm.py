...
class StereoCamera:
    def __init__(self, args):
        ...
        if args.ximea:
            ...
            print("Opening Camera XIMEA")
            self.mainCAM = cv2.VideoCapture(0)
            self.camL = cv2.VideoCapture(2)
